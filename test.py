...
def run_tests(verbosity):
    ...
    file_list = os.listdir(os.path.join(os.path.abspath(os.path.dirname(os.path.realpath(__file__))), 'test'))
    test_modules = []
    ...
    for file_name in file_list:
        ...
        if extension == '.py':
            ...
            test_module_name = "test." + os.path.splitext(file_name)[0:-1][0]
